...
// Function to fetch user data from Firebase
  Future<void> _fetchFollowingRuns() async {
    ...
    if (currentUser != null) {
      ...
      _database.child("Users").child(uid).child("followingRunes").onValue.listen((event) {
  ...
  Future<void> _unfollowRuns(String eventId) async {
    ...
    if (currentUser != null) {
      ...
      try {
        await _database.child("Users").child(uid).child("followingRunes").child(eventId).remove();
    ...
    if (currentUser != null) {
      ...
      if (event.snapshot.exists) {
        ...
        setState(() {
          ...
          _profileImageUrl = data['profileImageUrl'] ?? _profileImageUrl; // Update profile image
        });
  ...
  Future<void> _fetchDogs(String uid) async {
    DatabaseEvent event = await _database.child('Users').child(uid).child('MyDogs').once();
    if (event.snapshot.exists) {
  ...
  Future<void> _editDog(BuildContext context, String dogId, String currentName, String currentImageUrl) async {
    ...
    await showDialog(
      context: context,
      barrierDismissible: false, // Prevent dismissing the dialog when clicking outside
      builder: (context) {
              ...
              actions: isLoading
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    ...
                    await _database.child('Users').child(_auth.currentUser!.uid).child('MyDogs').child(dogId).update({
                      'name': dogNameController.text,
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      setState(() {}); // Update the dialog UI to show the selected image
                    },
                  ),
                  ElevatedButton.icon(
                    icon: const Icon(Icons.image),
                ...
                TextButton(
                  ...
                  onPressed: () async {
                    if (image != null) {
                      ...
                      String uid = _auth.currentUser!.uid;
                      Reference ref = _storage.ref().child('profileImages/$uid');
                      await ref.putFile(File(image!.path));
                      ...
                      Navigator.of(context).pop(); // Close dialog after upload completes
              ...
              ClipRRect(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    dog['name']!,
                    style: TextStyle(
                        fontWeight: FontWeight.bold, fontFamily: "Poppins", fontSize: 16.sp),
                  ),
                ),
              ),
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    _editDog(context, dog['id']!, dog['name']!, dog['imageUrl']!);
                  },
                ),
              ),
            ],
  ...
  Widget _buildTextField( TextEditingController controller, VoidCallback onEdit) {
    return Row(
      children: [
        Expanded(
          child: TextFormField(
  ...
  Future<void> _showEditDialog(BuildContext context, String field) async {
    TextEditingController controller = (field == 'name') ? _nameController : _emailController;
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: InputDecoration(labelText: field == 'name' ? 'Name' : 'Email'),
          ),
          actions: <Widget>[
            TextButton(
              child: const Text('Cancel'),
          ...
          Padding(
            ...
            child: InkWell(
              ...
              child: Row(
                children: [
                  IconButton(
                    icon: const Icon(Icons.logout, color: AppColors.buttonColor),
                    onPressed: _logout, // Logout button
                  ),
                  const Text("Logout", style: TextStyle(color: AppColors.buttonColor)),
                ],
              ),
            ),
          ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                ...
                children: [
                  ClipRRect(
                    ...
                    child: _profileImageUrl.contains('assets')
                        ? Image.asset(_profileImageUrl, width: 140.w, height: 140.h)
                        : Image.network(
                      _profileImageUrl,
                      width: 140.w,
                      height: 140.h,
                  ...
                  Positioned(
                    ...
                    right: 0,
                    child: IconButton(
                      icon:  Icon(Icons.edit, color: Colors.black,size: 38.h,),
              ...
              Text(_nameController.text, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.sp)),
              SizedBox(height: 20.h),
              Align(
              ...
              _buildTextField( _nameController, () => _showEditDialog(context, 'name')),
              SizedBox(height: 20.h),
              Align(
                alignment: Alignment.centerLeft,
              ...
              SizedBox(height: 10.h),
              _buildTextField( _emailController, () => _showEditDialog(context, 'email')),
              SizedBox(height: 20.h),
              RoundButton(title: "Upgrade To Host", onPress: () {}),
              SizedBox(height: 20.h),
              Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  "My Dogs",
                  style: TextStyle(fontSize: 16.h, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),
                ),
              ),
              SizedBox(height: 20.h),
              _buildDogsList(),
              ElevatedButton.icon(
                ...
                label: Text("Add Dogs", style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.bold, color: Colors.white)),
              ...
              _isLoading
                  ...
                  ? ListView.builder(
                shrinkWrap: true, // Ensures it fits within the available space
